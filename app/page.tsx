...
export default function Home() {
  ...
  const allProjects = [...projects, ...publishedProjects]
    .map((project) =>
  ...
  return (
    ...
    >
      ...
      <section className="hero shell" id="top">
        ...
        <div className="portal" aria-label={language === "en" ? "VR Property Viewing project preview" : "VR 房产展示项目预览"}>
          <div className="portalGlow" />
          <div className="orbit orbitOne" />
          <div className="orbit orbitTwo" />
          <div className="projectFrame heroFrame">
            <img src="/projects/published/vr-property-viewing/cover.webp" alt={language === "en" ? "VR Property Viewing project cover" : "VR 房产展示项目封面"} />
            <div className="frameShade" aria-hidden="true" />
            <div className="frameHud frameHudTop" aria-hidden="true"><span>VR_PROPERTY_01</span><span>LIVE</span></div>
            <div className="frameHud frameHudBottom" aria-hidden="true"><span>VR PROPERTY VIEWING</span><span>01</span></div>
          </div>
      ...
      <footer className="footer shell">
        ...
        <div className="footerLinks"><a href="#top">{t.backTop} ↑</a></div>
      </footer>
